          ...
          <div>
            <div className={ham ? "home-right" : "home-right1"}>
              ...
              <div className="right-block-container">
                ...
                <div className="affiliate-right-block2-container">
                <div className="affiliate-right-block2">
                    <div className="affiliate-right-block2-part1">
                      <div className="affiliate-right-block2-part1-header">
                        CAPTURE PAGE
                      </div>
                      <div className="affiliate-right-block2-part1-body">
                        <div className="affiliate-right-block2-part1-left">
                          <img
                            className="affiliate-img"
                            src="https://affiliateindians.com/ai/assets/capture-page/cp1.png"
                            alt="no found"
                          />
                        ...
                        <div className="affiliate-right-block2-part1-right">
                          <div className="affiliate-right-block2-part1-right1">
                            <p style={{ fontSize: "16px" }}>Affilate Link:</p>
                            <div className="inner">
                              <input style={{ height: "38px",width:"80%" }} type="text" />
                              <button className="copy">COPY</button>
                            </div>
                          </div>
                          <div className="affiliate-right-block2-part1-right2">
                            <p style={{ fontSize: "16px" }}>Tracking Tag:</p>
                            <div className="inner">
                              <input style={{ height: "38px",width:"80%" }} type="text" />
                    ...
                    <div className="affiliate-right-block2-part1">
                      ...
                      <div className="affiliate-right-block2-part1-body">
                        <div className="affiliate-right-block2-part1-left">
                          <img
                            className="affiliate-img"
                            src="https://affiliateindians.com/ai/assets/capture-page/landing.png"
                            alt="no found"
                          />
                          <button className="img-button">
                            {" "}
                    ...
                    <div className="affiliate-right-block2-part1">
                      ...
                      <div className="affiliate-right-block2-part1-body">
                        <div className="affiliate-right-block2-part1-left">
                          <img
                            className="affiliate-img"
                            src="https://affiliateindians.com/ai/assets/capture-page/sales.png"
                            alt="no found"
                          />
                          <button className="img-button">
                            {" "}
                    ...
                    <div className="affiliate-right-block2-part1">
                      ...
                      <div className="affiliate-right-block2-part1-body">
                        <div className="affiliate-right-block2-part1-left">
                          <img
                            className="affiliate-img"
                            src="https://affiliateindians.com/ai/assets/capture-page/checkout.png"
                            alt="no found"
                          />
                          <button className="img-button">
                            {" "}
