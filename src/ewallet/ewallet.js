          ...
          <div>
            <div className={ham ? "home-right" : "home-right1"}>
              ...
              <div className="right-block-container">
                ...
                <div className="ewallet-right-block2-container">
                  <div className="ewallet-right-block2">
                    <div className="ewallet-right-block2-header">
                      Access Your Wallet
                    </div>
                    <div className="ewallet-right-block2-body">
                      <div className="ewallet-right-block2-body1">
                        Wallet Amount
                      </div>
                      <div className="ewallet-right-block2-body2">₹ 999.6</div>
                      <div className="ewallet-right-block2-body3">
                        <button className="ewallet-button">
                          Redeem Amount
                        </button>
                      </div>
                    </div>
          ...
          <div>
            <div className={ham ? "home-right1" : "home-right"}>
              ...
              <div className="right-block-container">
                ...
                <div className="ewallet-right-block3-container">
                <div className="ewallet-right-block3">
                  <div className="ewallet-right-block3-header">
                    Redeem Requests
                  </div>
                  <div className="ewallet-right-block3-body">
                    <div className="ewallet-right-block3-body1">
                     S.No.
                    </div>
                    <div className="ewallet-right-block3-body2">Amount</div>
                    <div className="ewallet-right-block3-body3">Redeem Date</div>
                    <div className="ewallet-right-block3-body4">Status</div>
                  </div>
                  <div className="ewallet-right-block3-bottom">No Data Available</div>
                </div>
              </div>
              <div className="copyright">2020 © copyright</div>
              </div>
