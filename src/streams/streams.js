        ...
        {matches ? (
          <div>
            <div className={ham ? "home-right" : "home-right1"}>
              ...
              <div className="right-block-container">
                ...
                <div className="stream-right-block2-container">
                  <div className="stream-right-block2">
                    <div className="stream-right-block2-header">
                      Streams of Income
                    </div>
                    <div className="stream-right-block2-body-part1">
                      <div className="stream-right-block2-body1">1</div>
                      <div className="stream-right-block2-body2">
                        25 DOLLAR 1UP
                      </div>
                      <div className="stream-right-block2-body3">
                        <button className="stream-button">
                          Call to Action
                        </button>
                      </div>
                    </div>
                    <div className="stream-right-block2-body-part2">
                      <div className="stream-right-block2-body1">2</div>
                      <div className="stream-right-block2-body2"></div>
                      <div className="stream-right-block2-body3"></div>
                    </div>
                    <div className="stream-right-block2-body-part3">
                      <div className="stream-right-block2-body1">3</div>
                      <div className="stream-right-block2-body2">
                        BUILDERALL
                      </div>
                      <div className="stream-right-block2-body3">
                    ...
                    <div className="stream-right-block2-body-part4">
                      <div className="stream-right-block2-body1">4</div>
                      <div className="stream-right-block2-body2">
                        LEGENDARY MARKETER
                      </div>
                      <div className="stream-right-block2-body3">
                    ...
                    <div className="stream-right-block2-body-part5">
                      <div className="stream-right-block2-body1">5</div>
                      <div className="stream-right-block2-body2">NETMONEY</div>
                      <div className="stream-right-block2-body3">
                        <button className="stream-button">
                          Call to Action
                        </button>
                    ...
                    <div className="stream-right-block2-body-part6">
                      <div className="stream-right-block2-body1">6</div>
                      <div className="stream-right-block2-body2">
                        DIGITAL INNCOME
                      </div>
                      <div className="stream-right-block2-body3">
                    ...
                    <div className="stream-right-block2-body-part7">
                      <div className="stream-right-block2-body1">7</div>
                      <div className="stream-right-block2-body2">MOBINCOME</div>
                      <div className="stream-right-block2-body3">
                        <button className="stream-button">
                          Call to Action
                        </button>
          ...
          <div>
            <div className={ham ? "home-right1" : "home-right"}>
              <div className="right-header">
                <div className="header-heading">Streams of Indians</div>
                <div className="sidewords">
                  <NavLink
                    style={{
                      color: "#9BA3AA",
