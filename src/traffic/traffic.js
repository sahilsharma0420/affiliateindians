        ...
        {matches ? (
          <div>
            <div className={ham ? "home-right" : "home-right1"}>
              ...
              <div className="right-block-container">
                ...
                <div className="traffic-right-block2-container">
                  <div className="traffic-right-block2">
                    <div className="traffic-right-block2-header">
                      Get Traffic
                    </div>
                    <div className="traffic-right-block2-body">
                      <div className="traffic-right-block2-body1">1</div>
                      <div className="traffic-right-block2-body2">UDIMI</div>
                      <div className="traffic-right-block2-body3">
          ...
          <div>
            <div className={ham ? "home-right1" : "home-right"}>
              <div className="right-header">
                <div className="header-heading">Get Traffic</div>
                <div className="sidewords">
                  <NavLink
                    style={{
                      color: "#9BA3AA",
