    ...
    <>
      ...
      <div className="home">
        ...
        <div className="home-left2">
          ...
          <div className="stream">
            <NavLink to="#">
              <RampRightIcon style={{ marginRight: "10px" }} /> [PRO] Streams of
              Income
            </NavLink>
          </div>
          <div className="traffic">
        ...
        {matches ? (
          <div>
            <div className={ham ? "home-right" : "home-right1"}>
              ...
              <div className="right-block-container">
                ...
                <div className="reports-right-block2-container">
                  <div className="reports-right-block2">
                    <div className="reports-right-block2-header">
                      <div className="reports-right-block2-header1">
                        Products
                      </div>
                      <div className="reports-right-block2-header2">
                        Customers
                      </div>
                      <div className="reports-right-block2-header3">Sales</div>
                      <div className="reports-right-block2-header4">
                        Commisions
                      </div>
                      <div className="reports-right-block2-header5">
                        Refunds
                      </div>
                      <div className="reports-right-block2-header6">
                        Net Income
                      </div>
                    </div>
                    <div className="reports-right-block2-body">
                      No Data Available
                    </div>
                  </div>
                </div>
          ...
          <div>
            <div className={ham ? "home-right1" : "home-right"}>
              <div className="right-header">
                <div className="header-heading">Reports</div>
                <div className="sidewords">
                  <NavLink
                    style={{
                      color: "#9BA3AA",
