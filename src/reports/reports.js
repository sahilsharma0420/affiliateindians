          ...
          <div className="right-block-container">
            ...
            <div className="reports-right-block2">
                    <div className="reports-right-block2-header">
                      <div className="reports-right-block2-header1">Products</div>
                      <div className="reports-right-block2-header2">Customers</div>
                      <div className="reports-right-block2-header3">Sales</div>
                      <div className="reports-right-block2-header4">Commisions</div>
                      <div className="reports-right-block2-header5">Refunds</div>
                      <div className="reports-right-block2-header6">Net Income</div>
