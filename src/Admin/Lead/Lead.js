...
import Leadtable from "./Leadtable.js";
  ...
  return (
    <>
      ...
      <div className="logout">
        ...
        {matches ? (
          <div>
            <div className={ham ? "Lead-home-right" : "Lead-home-right1"}>
              ...
              <div className="Lead-right-block-container">
                <div className="Lead-right-block">
                  <div className="Lead-right-block-header">
                    <div className="Lead-right-block-header1">S.No.</div>
                    <div className="Lead-right-block-header2">Date</div>
                    <div className="Lead-right-block-header3">Funnel</div>
                    <div className="Lead-right-block-header4">Tag</div>
                    <div className="Lead-right-block-header5">Name</div>
                    <div className="Lead-right-block-header6">Email</div>
                    <div className="Lead-right-block-header7">Phone</div>
                  </div>
                  <Leadtable details={Leaddata} />
                </div>
              </div>
          ...
          <div>
            <div className={ham ? "Lead-home-right1" : "Lead-home-right"}>
              <div className="right-header">
                <div className="header-heading">Lead</div>
                <div className="sidewords">
                  <NavLink
                    style={{
                      color: "#9BA3AA",
