...
import { Month, Date, Timing } from "./Schedulecallsdata";
...
function Schedulecalls() {
  ...
  const handleservice = (id) => {
    const s1 = Date.filter((x) => x.monthId === id);
    setdate(s1);
  };
  const close = () => {
    if (show === false) {
      ...
      <div className="logout">
        ...
        {matches ? (
          <div>
            <div
              className={
                ham ? "schedulecalls-home-right" : "schedulecalls-home-right1"
              }
            >
              ...
              <div className="schedulecalls-right-block-container">
                <div className="schedulecalls-box">
                  <p className="schdedulecalls-heading">Schedule Calls</p>
                  <div className="schedulecalls-right-block-container-row1">
                    <div className="month">
                    ...
                    <div className="timing">
                      ...
                      <select>
                        <option className="outeroption">Select Timing</option>
                        {Timing.map((ctr, index) => {
                          return (
                            <>
                              <option key={index} value={ctr.id}>
                                {ctr.time}
                  ...
                  <div className="schedulecalls-right-block-container-row2">
          ...
          <div>
            <div
              className={
                ham ? "schedulecalls-home-right1" : "schedulecalls-home-right"
              }
            >
              <div className="right-header">
                <div className="header-heading">Schedule Calls</div>
                <div className="sidewords">
                  <NavLink
                    style={{
                      color: "#9BA3AA",
