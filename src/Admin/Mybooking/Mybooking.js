    ...
    <>
      ...
      <div className="logout">
        ...
        {matches ? (
          <div>
            <div
              className={ham ? "mybooking-home-right" : "mybooking-home-right1"}
            >
              ...
              <div className="mybooking-right-block-container">
                <div className="mybooking-right-block">
                  <div className="mybooking-right-block-header">My Booking</div>
                  <Mybookingtable details={Mybookingdata} />
                </div>
              </div>
          ...
          <div>
            <div
              className={ham ? "mybooking-home-right1" : "mybooking-home-right"}
            >
              <div className="right-header">
                <div className="header-heading">My Bookings</div>
                <div className="sidewords">
                  <NavLink
                    style={{
                      color: "#9BA3AA",
