    ...
    <>
      ...
      <div className="logout">
        ...
        {matches ? (
          <div>
            <div
              className={ham ? "ewallets-home-right" : "ewallets-home-right1"}
            >
              ...
              <div className="ewallets-right-block-container">
                <div className="right-ewallets">
                  <div className="ewallets-right-block2">
                    <div className="ewallets-right-block2-header">
                      <div className="ewallets-right-block2-header1">
                        Sr No.
                      </div>
                      <div className="ewallets-right-block2-header2">Name</div>
                      <div className="ewallets-right-block2-header3">Amout</div>
                      <div className="ewallets-right-block2-header4">
                        Redeem Date
                      </div>
                      <div className="ewallets-right-block2-header5">
                        Action
                      </div>
                    </div>
                    <div className="ewallets-right-block2-body1">
                      <div className="ewallets-right-block2-body1-part1">1</div>
                      <div className="ewallets-right-block2-body1-part2">
                        Prakhar Kulshrestha
                      </div>
                      <div className="ewallets-right-block2-body1-part3">
                        500
                      </div>
                      <div className="ewallets-right-block2-body1-part4">
                        2020-05-15 23:09:28
                      </div>
                      <div className="ewallets-right-block2-body1-part5">
                        2020-05-15 23:09:28
                      </div>
                    </div>
                  </div>
          ...
          <div>
            <div
              className={ham ? "ewallets-home-right1" : "ewallets-home-right"}
            >
              <div className="right-header">
                <div className="header-heading">ewallet</div>
                <div className="sidewords">
                  <NavLink
                    style={{
                      color: "#9BA3AA",
              ...
              <div className="ewallets-right-block-container">
                <div className="right-ewallets">
                  <div className="ewallets-right-block2-header">
                    <div className="ewallets-right-block2-header1">Sr No.</div>
                    <div className="ewallets-right-block2-header2">Name</div>
                    <div className="ewallets-right-block2-header3">Amout</div>
                    <div className="ewallets-right-block2-header4">
                      Redeem Date
                    </div>
                    <div className="ewallets-right-block2-header5">Action</div>
                  </div>
                  <div className="ewallets-right-block2-body1">
                    <div className="ewallets-right-block2-body1-part1">1</div>
                    <div className="ewallets-right-block2-body1-part2">
                    ...
                    <div className="ewallets-right-block2-body1-part3">500</div>
                    <div className="ewallets-right-block2-body1-part4">
                      2020-05-15 23:09:28
                    </div>
                    <div className="ewallets-right-block2-body1-part5">
