  ...
  return (
    <>
      ...
      <div className="logout">
        ...
        {matches ? (
          <div>
            <div className={ham ? "members-home-right" : "members-home-right1"}>
              ...
              <div className="members-right-block-container">
                <div className="members-right-block">
                  <div className="members-right-block-header">
                    <div className="members-right-block-header1">S.No.</div>
                    <div className="members-right-block-header2">Date</div>
                    <div className="members-right-block-header3">Funnel</div>
                    <div className="members-right-block-header4">Tag</div>
                    <div className="members-right-block-header5">Name</div>
                    <div className="members-right-block-header6">Email</div>
                    <div className="members-right-block-header7">Phone</div>
                    <div className="members-right-block-header8">
                      Last Training day Completed
                    </div>
                  </div>
                  <Memberstable details={Membersdata} />
                </div>
              </div>
          ...
          <div>
            <div className={ham ? "members-home-right1" : "members-home-right"}>
              <div className="right-header">
