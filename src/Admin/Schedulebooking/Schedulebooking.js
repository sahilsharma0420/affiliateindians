...
import { Schedulebookingdata } from "./Schedulebookingdata";
import Schedulebookingtable from "./Schedulebookingtable";
  ...
  return (
    <>
      ...
      <div className="logout">
        ...
        {matches ? (
          <div>
            <div className={ham ? "schedulebooking-home-right" : "schedulebooking-home-right1"}>
              ...
              <div className="schedulebooking-right-block-container">
              <div className="schedulebooking-right-block">
                <div className="schedulebooking-right-block-header">
                  Scheduled Booking
                </div>
                <Schedulebookingtable details={Schedulebookingdata} />
              </div>
            </div>
          ...
          <div>
            <div
              className={
                ham
                  ? "schedulebooking-home-right1"
                  : "schedulebooking-home-right"
              }
            >
              <div className="right-header">
