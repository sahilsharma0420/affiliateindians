...
import { Registeredusersdata } from "./Registeredusersdata.js";
import Registereduserstable from "./Registereduserstable.js";
        ...
        {matches ? (
          <div>
            <div
              className={
                ham
                  ? "registeredusers-home-right"
                  : "registeredusers-home-right1"
              }
            >
              ...
              <div className="registeredusers-right-block-container">
                <div className="registeredusers-right-block">
                  <div className="registeredusers-right-block-header">
                    <div className="registeredusers-right-block-header1">
                      S.No
                    </div>
                    <div className="registeredusers-right-block-header2">
                      Name
                    </div>
                    <div className="registeredusers-right-block-header3">
                      Email
                    </div>
                    <div className="registeredusers-right-block-header4">
                      Mobile
                    </div>
                    <div className="registeredusers-right-block-header5">
                      Address
                    </div>
                    <div className="registeredusers-right-block-header6">
                      City
                    </div>
                    <div className="registeredusers-right-block-header7">
                      State
                    </div>
                    <div className="registeredusers-right-block-header8">
                      Country
                    </div>
                    <div className="registeredusers-right-block-header9">
                      Pincode
                    </div>
                    <div className="registeredusers-right-block-header10">
                      Date of Joining
                    </div>
                    <div className="registeredusers-right-block-header11">
                      AID
                    </div>
                    <div className="registeredusers-right-block-header12">
                      AID Name
                    </div>
                    <div className="registeredusers-right-block-header13">
                      Paid Status
                    </div>
                    <div className="registeredusers-right-block-header14">
                      Login Token
                    </div>
                    <div className="registeredusers-right-block-header15">
                      Last Login
                    </div>
                    <div className="registeredusers-right-block-header16">
                      Block/Unblock
                    </div>
                  </div>
                  <Registereduserstable details={Registeredusersdata} />
                </div>
              </div>
          ...
          <div>
            ...
            >
              <div className="right-header">
                <div className="header-heading">Registered Users</div>
                <div className="sidewords">
                  <NavLink
                    style={{
                      color: "#9BA3AA",
