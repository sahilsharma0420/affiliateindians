      ...
      <div className="logout">
        ...
        {matches ? (
          <div>
            <div
              className={
                ham ? "viewadvisor-home-right" : "viewadvisor-home-right1"
              }
            >
              ...
              <div className="viewadvisor-right-block-container">
                <div className="right-viewadvisor">
                  <div className="viewadvisor-right-block2">
                    <div className="viewadvisor-main-header">View Advisors</div>
                    <div className="viewadvisor-right-block2-header">
                      <div className="viewadvisor-right-block2-header1">
                        S.No.
                      </div>
                      <div className="viewadvisor-right-block2-header2">
                        Name
                      </div>
                      <div className="viewadvisor-right-block2-header3">
                        Email
                      </div>
                      <div className="viewadvisor-right-block2-header4">
                        Mobile
                      </div>
                      <div className="viewadvisor-right-block2-header5">
                        Image
                      </div>
                    </div>
                    <div className="viewadvisor-right-block2-body1">
                      <div className="viewadvisor-right-block2-body1-part1">
                        1
                      </div>
                      <div className="viewadvisor-right-block2-body1-part2">
                        Prakhar Kulshrestha
                      </div>
                      <div className="viewadvisor-right-block2-body1-part3">
                        appointments@affiliateindians.com
                      </div>
                      <div className="viewadvisor-right-block2-body1-part4">
                        NAN
                      </div>
                      <div className="viewadvisor-right-block2-body1-part5">
                        VIEW
                      </div>
                    </div>
                  </div>
          ...
          <div>
            <div
              className={
                ham ? "viewadvisor-home-right1" : "viewadvisor-home-right"
              }
            >
              <div className="right-header">
                <div className="header-heading">View Advisors</div>
                <div className="sidewords">
                  <NavLink
                    style={{
                      color: "#9BA3AA",
